...
//Register(CSS locators)
		  driver.findElement(By.cssSelector("table:nth-child(1) tbody:nth-child(1) tr:nth-child(1) td.mouseOut:nth-child(2) > a:nth-child(1)")).click();
...
//Country
		...
		Select dropdown1 = new Select(driver.findElement(By.xpath("//select[@name='country']")));
...
// One way click (CSS Selectors)
		driver.findElement(By.xpath("/html[1]/body[1]/div[1]/table[1]/tbody[1]/tr[1]/td[2]/table[1]/tbody[1]/tr[4]/td[1]/table[1]/tbody[1]/tr[1]/td[2]/table[1]/tbody[1]/tr[5]/td[1]/form[1]/table[1]/tbody[1]/tr[2]/td[2]/b[1]/font[1]/input[2]")).click();
		Thread.sleep(5000);
